...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MLListViewController *listView = [[MLListViewController alloc] init];    
...
- (void)applicationWillResignActive:(UIApplication *)application {
    ...
    [totalDataArray addObjectsFromArray:[MLDownloadManager shareManager].downloadingModels];
    [totalDataArray addObjectsFromArray:[MLDownloadManager shareManager].waitingModels];
    
    for (MLNetworkingDownloadModel *model in totalDataArray) {
